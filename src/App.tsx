...
function TechStatCard({
  ...
  return (
    <div className="tech-stat-card">
      ...
      <div className="tech-stat-sub">{sub}</div>
    </div>
  );
}
        ...
        <section id="about">
          ...
          <div className="about-grid reveal">
            ...
            <div className="about-tech-stats">
              <div className="tech-stats-header">Technologies in my stack</div>
              <div className="tech-stats-grid">
                {TECH_STATS.map((s) => (
                  <TechStatCard key={s.label} {...s} />
                ))}
              </div>
            </div>
          </div>
          ...
          <div className="projects-grid reveal">
            ...
            <ProjectCard
              ...
              stack={[
                ...
                { label: "SentenceTransformer", color: "blue" },
                { label: "PostgreSQL", color: "purple" },
            ...
            <div>
              ...
              <div className="edu-courses">
                {[
                  ...
                  "Computer Networks & Distributed Processing",
                  "Operating Systems",
...
const CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  :root {
  --bg:       #F8FCFB;   /* soft mint-white background */
  --surface:  #BFE8E2;   /* seafoam green */
  --surface2: #BFDDF6;   /* pastel blue */
  --border:   rgba(74, 122, 117, 0.12);

  --accent:   #4D7C8A;   /* muted ocean blue */
  --accent2:  #7FC8B2;   /* seafoam accent */
  --accent3:  #A7D8F2;   /* light pastel blue */

  --text:     #24424A;   /* deep muted teal for readability */
  --muted:    #5F7C84;   /* softer muted text */
  ...
  .hero-name .line-2 { display: block; color: transparent; -webkit-text-stroke: 1px rgba(0, 3, 34, 0.12); }
  .hero-tagline {
  ...
  /* ── Tech stats panel ── */
  .about-tech-stats { display: flex; flex-direction: column; gap: 16px; }
  .tech-stats-header {
    font-family: var(--font-mono); font-size: 0.68rem; color: var(--accent);
    letter-spacing: 0.18em; text-transform: uppercase;
    display: flex; align-items: center; gap: 10px;
  }
  .tech-stats-header::before { content:''; width:24px; height:1px; background: var(--accent); }
  .tech-stats-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 14px; }
  .tech-stat-card {
    background: var(--surface); border: 1px solid var(--border); border-radius: 8px;
    padding: 24px 20px; transition: border-color 0.25s, transform 0.25s;
  }
  .tech-stat-card:hover { border-color: rgba(143,184,168,0.35); transform: translateY(-3px); }
  .tech-stat-num {
